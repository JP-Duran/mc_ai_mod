...
public class DwarfModel extends EntityModel<DwarfRenderState> {
    public static final EntityModelLayer DWARF = new EntityModelLayer(Identifier.of(DwarfMod.MOD_ID, "mantis"), "main");
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData body = mantis.addChild("body", ModelPartBuilder.create().uv(0, 0).cuboid(-2.5F, -1.0F, 8.75F, 5.0F, 2.0F, 25.0F, new Dilation(0.0F))
                .uv(0, 0).cuboid(-3.5F, -2.0F, -51.25F, 7.0F, 4.0F, 60.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -5.0F, 0.0F,    // Position (make Y more negative to raise)
                                                                                                                                                                                            0.0F, -12.0F, 26.25F));   // Rotation (same as before)
    ...
    @Override
    public void setAngles(DwarfRenderState dwarfRenderState) {
        super.setAngles(dwarfRenderState);
        this.animate(dwarfRenderState.idlingAnimationState, DwarfAnimations.IDLE, dwarfRenderState.age, 1);
        this.animateWalking(DwarfAnimations.WALK, dwarfRenderState.limbSwingAnimationProgress, dwarfRenderState.limbSwingAmplitude, 2.0F, 2.5F);
    }
}
